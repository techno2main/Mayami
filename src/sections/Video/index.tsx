    ...
    <section id="video" className="relative bg-magenta py-20 sm:py-28">
      ...
      <div className="relative mx-auto max-w-6xl px-5 sm:px-8">
        <div className="flex items-end justify-between gap-4">
          <div>
            <p className="font-poster text-xs uppercase tracking-[0.3em] text-(--cream)/80">03 / Watch</p>
            <h2 className="mt-2 font-display text-5xl leading-[0.9] text-cream sm:text-7xl">Official Video</h2>
            <p className="mt-3 max-w-xl text-(--cream)/90">
              A love letter to Miami — shot on sunset walls, neon boulevards and the Atlantic shoreline.
            </p>
          </div>
        </div>
